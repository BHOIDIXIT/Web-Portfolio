...
export default function ContactSection() {
  return (
    <section id="contact" className="Primary py-16">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-6">
          Contact
        </h1>

        <p className="text-gray-400 text-sm md:text-base leading-7 max-w-3xl mb-6">
        ...
        <div className="icons flex items-center gap-4 mt-6 text-gray-400">
          {/* <!-- Instagram --> */}
          <svg
